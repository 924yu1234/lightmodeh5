...
export const StyledXStocksDetail = styled.div<{ listWidth: number }>`
  height: 100%;
  display: flex;
  ...
  .detail-content-portfolio {
    &.open {
      width: ${({ listWidth }: { listWidth: number }) => listWidth}px;
      min-width: ${({ listWidth }: { listWidth: number }) => listWidth}px;
    }
    padding-left: 20px;
    height: 100%;
    display: flex;
