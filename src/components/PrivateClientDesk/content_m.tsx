...
export default function PrivateClientDeskContentMobile({
  showHideEntryBtn,
  onClickHideEntryBtn,
  className,
}: {
            ...
            return (
              <div key={row.key} className="contact-row">
                <div className="channel-icon">
                  {row.key === 'telegram' && (
                    <IconPrivateClientDeskVipTelegram />
                  )}
                  {row.key === 'whatsapp' && (
                    <IconPrivateClientDeskVipWhatsapp />
                  )}
                  {row.key === 'signal' && <IconPrivateClientDeskVipSignal />}
                  {row.key === 'email' && <IconPrivateClientDeskVipEmail />}
                </div>
