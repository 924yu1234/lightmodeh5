...
export default function InfoLeft(props) {
  ...
  return (
    <StyledSpan className={`${className} dg-icon icon-info-left`} {...rest}>
      <svg width="24px" height="122px" viewBox="0 0 24 122" version="1.1">
        ...
        >
          <g
            id="arrow-next"
            transform="translate(12.000000, 61.000000) scale(-1, 1) translate(-12.000000, -61.000000) translate(3.000000, 1.000000)"
          >
            <g id="矩形">
              <use
                fill="black"
