...
export default function IconSortDown({
  ...
  return (
    <StyledSpan
      className={`${className} dg-icon icon-sort-down`}
      onClick={onClick}
      {...rest}
    >
      <svg width="12px" height="6px" viewBox="0 0 12 6" version="1.1">
        <title>arrow sorting default down</title>
        <g
          id="arrow-sorting-default-down"
          stroke="none"
          strokeWidth="1"
          fill="none"
          fillRule="evenodd"
        >
          ...
          >
            <path
              ...
              id="Triangle"
              transform="translate(4.375, 2.1875) scale(1, -1) translate(-4.375, -2.1875)"
            ></path>
          </g>
        </g>
      </svg>
