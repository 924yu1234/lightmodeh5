...
export default function DualDepositView({
  order,
}: {
  ...
  const { minPrice, maxPrice, tryResp, baseAmount, quoteAmount } =
    order.dualDepositOrderParams as TurboRangeDualDepositOrderParams;
