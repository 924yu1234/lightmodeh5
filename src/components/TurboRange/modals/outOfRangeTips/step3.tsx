  ...
  return (
    <StyledStepIndex>
      <div className="step-title">
        {intl.turboRange.if_you_think_XXX_s_price_will_keep_falling.replace(
          '{XXX}',
          name
        )}
      </div>
      ...
      <div className="step-item">
        {intl.turboRange.close_position_and_withdraw_USDC}
      </div>
      <div className="btns">
        <GhostBtn
          className="btn"
          eventName="turbo_range_out_of_range_tips_step3_back"
        ...
        <PrimaryBtn
          className="btn"
          eventName="turbo_range_out_of_range_tips_step3_close_position"
          onClick={() => {
            hide();
            showModal({
