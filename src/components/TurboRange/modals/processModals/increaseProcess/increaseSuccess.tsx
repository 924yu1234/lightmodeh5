...
import IncreaseInvestmentInvested from '../../details/increseInvestmentDetail/invested';
...
export default function IncreaseSuccess({
  ...
  return (
    <StyledView className="status-view">
      ...
      <div className="text">{intl.turboRange.investment_increased}</div>

      <IncreaseInvestmentInvested data={order} />
      <PrimaryBtn
