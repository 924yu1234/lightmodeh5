...
import { TurboRangeClaimOrderParams } from 'src/constants/interface';
import { useIntl } from 'src/locals';
import { ThemeType } from 'src/theme';
import EstNetworkFee from 'src/wallet/components/EstNetworkFee';

export default function ClaimView({ order }: { order: any }) {
  const intl = useIntl();
  const { tryResp, estClaims } = (order.claimOrderParams ||
    {}) as TurboRangeClaimOrderParams;
